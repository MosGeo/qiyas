...
# =================================================================================================
def load_from_tables(unit_tables_directory:Path,
                     is_force_add:bool=False,
                     is_construct:bool=False)->UnitConvertor:
    ...
    for type_name in type_names:
        unit_graphs[type_name] = read_unit_table(type_name, unit_tables_directory,
